...
$routes->post('chat/message/(:num)/pin',       'ChatController::pinMessage/$1');
$routes->get( 'chat/conversation/(:num)/pinned', 'ChatController::getPinnedMessages/$1');
$routes->post('chat/message/(:num)/forward',   'ChatController::forwardMessage/$1');
...
$routes->group('api', ['filter' => 'cors'], static function ($routes) {
    $routes->group('', ['filter' => 'apijwt'], static function ($routes) {
        ...
        $routes->put('classroom/discussion/(:num)/edit',                  'Api\ClassroomController::classDiscussionEdit/$1');
        $routes->delete('classroom/discussion/(:num)',                    'Api\ClassroomController::classDiscussionDelete/$1');
        $routes->post('classroom/discussion/(:num)/report',               'Api\ClassroomController::classDiscussionReport/$1');
        $routes->get('classroom/discussion/(:num)/reports',                'Api\ClassroomController::classDiscussionReports/$1');
        $routes->put('classroom/discussion/comment/(:num)/edit',          'Api\ClassroomController::classDiscussionCommentEdit/$1');
        $routes->delete('classroom/discussion/comment/(:num)',            'Api\ClassroomController::classDiscussionCommentDelete/$1');
        $routes->post('classroom/discussion/comment/(:num)/report',       'Api\ClassroomController::classDiscussionCommentReport/$1');
        $routes->get('classroom/discussion/comment/(:num)/reports',        'Api\ClassroomController::classDiscussionCommentReports/$1');
        $routes->put('classroom/discussion/reply/(:num)/edit',            'Api\ClassroomController::classDiscussionReplyEdit/$1');
        $routes->delete('classroom/discussion/reply/(:num)',              'Api\ClassroomController::classDiscussionReplyDelete/$1');
        $routes->post('classroom/discussion/reply/(:num)/report',         'Api\ClassroomController::classDiscussionReplyReport/$1');
        $routes->get('classroom/discussion/reply/(:num)/reports',          'Api\ClassroomController::classDiscussionReplyReports/$1');
        $routes->get('classroom/(:num)/discussion/reports',                'Api\ClassroomController::discussionModerationQueue/$1');
        $routes->post('classroom/discussion/report/(:num)/vote',          'Api\ClassroomController::discussionReportVote/$1');
        $routes->post('classroom/discussion/report/(:num)/decision',      'Api\ClassroomController::discussionReportDecision/$1');
        $routes->get('classroom/discussion/user/(:num)/report-history',   'Api\ClassroomController::discussionUserReportHistory/$1');
        $routes->post('classroom/discussion/user/(:num)/suspend',         'Api\ClassroomController::discussionUserSuspend/$1');
        ...
        $routes->get('classroom/lesson/discussion/comment/(:num)/reactions',      'Api\ClassroomController::lessonDiscussionCommentReactions/$1');
        ...
        $routes->put('classroom/lesson/discussion/(:num)/edit',                   'Api\ClassroomController::lessonDiscussionEdit/$1');
        $routes->delete('classroom/lesson/discussion/(:num)',                     'Api\ClassroomController::lessonDiscussionDelete/$1');
        $routes->post('classroom/lesson/discussion/(:num)/report',                'Api\ClassroomController::lessonDiscussionReport/$1');
        $routes->get('classroom/lesson/discussion/(:num)/reports',                 'Api\ClassroomController::lessonDiscussionReports/$1');
        $routes->put('classroom/lesson/discussion/comment/(:num)/edit',           'Api\ClassroomController::lessonDiscussionCommentEdit/$1');
        $routes->delete('classroom/lesson/discussion/comment/(:num)',             'Api\ClassroomController::lessonDiscussionCommentDelete/$1');
        $routes->post('classroom/lesson/discussion/comment/(:num)/report',        'Api\ClassroomController::lessonDiscussionCommentReport/$1');
        $routes->get('classroom/lesson/discussion/comment/(:num)/reports',         'Api\ClassroomController::lessonDiscussionCommentReports/$1');
        $routes->put('classroom/lesson/discussion/reply/(:num)/edit',             'Api\ClassroomController::lessonDiscussionReplyEdit/$1');
        $routes->delete('classroom/lesson/discussion/reply/(:num)',               'Api\ClassroomController::lessonDiscussionReplyDelete/$1');
        $routes->post('classroom/lesson/discussion/reply/(:num)/report',          'Api\ClassroomController::lessonDiscussionReplyReport/$1');
        $routes->get('classroom/lesson/discussion/reply/(:num)/reports',           'Api\ClassroomController::lessonDiscussionReplyReports/$1');
        ...
        $routes->post('chat/call-event',     'Api\ChatController::callEvent');
        ...
        $routes->post('chat/message/(:num)/pin',    'Api\ChatController::pinMessage/$1');
        $routes->get('chat/conversation/(:num)/pinned', 'Api\ChatController::getPinnedMessages/$1');
