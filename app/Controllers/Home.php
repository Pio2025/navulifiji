...
class Home extends BaseController
{
    ...
    private function moduleTours(): array
    {
        return [
            ...
            'hostel-dormitory' => ['tier' => 'Premium Modules', 'icon' => 'bi-house-door', 'label' => 'Hostel / Dormitory', 'description' => 'Manage boarding houses, room allocations and student residency in one place for schools with hostel or dormitory facilities.', 'highlights' => ['Room and bed allocation per student', 'Hostel/dormitory occupancy tracking', 'Boarding student records at a glance']],
