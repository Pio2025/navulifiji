...
class Home extends BaseController
{
    ...
    private function moduleTours(): array
    {
        return [
            ...
            'school-management' => ['tier' => 'Standard Modules', 'icon' => 'bi-building', 'label' => 'School Management', 'description' => 'Set up your school\'s profile, branding, categories and academic structure, with a shared calendar to keep everyone aligned on events, holidays and important dates.', 'highlights' => ['School profile, logo and branding setup', 'School categories, terms and academic structure', 'Shared calendar for events, holidays and important dates']],
            ...
            'transportation' => ['tier' => 'Premium Modules', 'icon' => 'bi-bus-front', 'label' => 'Transportation', 'description' => 'Digitise the Ministry of Education transport assistance allocation, from household eligibility details to a signature-ready application form.', 'highlights' => ['Auto-filled student, class and school details', 'Household income and e-transport card tracking', 'One-click Ministry application form for the Principal\'s signature']],
            ...
            'event' => ['tier' => 'Premium Modules', 'icon' => 'bi-calendar-event', 'label' => 'Event', 'description' => 'Plan, publish and track school events — from sports days to parent-teacher evenings — all from one calendar your whole community can see.', 'highlights' => ['Shared event calendar for the whole school', 'RSVP and attendance tracking per event', 'Automatic reminders to staff, students and parents']],
            ...
            'hostel-management' => ['tier' => 'Premium Modules', 'icon' => 'bi-house-door', 'label' => 'Hostel Management', 'description' => 'Manage boarding houses, room allocations and student residency in one place for schools with hostel or dormitory facilities.', 'highlights' => ['Room and bed allocation per student', 'Hostel/dormitory occupancy tracking', 'Boarding student records at a glance']],
