...
class AccountController extends BaseController
{
    ...
    public function progress(){
        ...
        $data['page_title'] = 'Registration Received';
        ...
        if (!empty($this->request->getPost())) {
            ...
            if (!$this->validate($validationRules, $validationMessages)) {
                ...
                $schoolData = [
                    ...
                    'sch_email'     => $this->request->getPost('my_email'),
                    'sch_password'  => $encryptedPassword,
                    'sch_motto' => $this->request->getPost('motto'),
                    'sch_primary_color' => $this->request->getPost('primary_color') ?: '#005B96',
                    'sch_secondary_color' => $this->request->getPost('secondary_color') ?: '#EE2A7B',
