	...
	<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			...
			<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
				...
				<li class="breadcrumb-item text-muted">User Listing</li>
			</ul>
		</div>
	</div>
</div>
	...
	<div id="kt_app_content_container" class="app-container container-xxl">
		...
		<div class="card">
			...
			<div class="card-header border-0 pt-6">
				<div class="card-title">
					...
					<div class="d-flex align-items-center position-relative my-1">
						...
						<input type="text" id="kt_user_search" class="form-control form-control-solid w-250px ps-13" placeholder="Search users..." />
					</div>
					<!--end::Search-->
				</div>
				<!--begin::Card toolbar-->
			...
			<div class="card-body py-4">
				<!--begin::Table-->
				<table id="kt_user_table" class="table align-middle table-row-dashed fs-6 gy-5">
					<thead>
...
var KTUsersList = function () {
    ...
    var initDatatable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            ajax: {
                url: "<?= base_url('user/getUserListing') ?>",
                type: "POST",
                data: function(d) {
            ...
            columns: [
                ...
                { data: 1, name: 'email' },
                { data: 2, name: 'phone' },
                { data: 3, name: 'role_name' },
                { data: 4, name: 'district_name' },
                { 
                    data: 5, 
                    name: 'status',
                    orderable: true
    ...
    var handleDeleteRows = function () {
        table.addEventListener('click', function(e) {
            const deleteButton = e.target.closest('[data-kt-users-table-filter="delete_row"]');
            ...
            const userName = row.querySelector('td:first-child .fw-bold').innerText.trim();
