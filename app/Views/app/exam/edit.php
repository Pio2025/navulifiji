    ...
    <div class="card shadow-sm" style="border:1px solid #E4E6EF; border-radius:4px;">
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <h3 class="fw-bold fs-4 text-gray-900"><?= esc($exam['exam_name']) ?></h3>
            </div>
        </div>
        <div class="card-body py-4">

            <form method="post" action="<?= base_url('exam/update/' . $exam['exam_id']) ?>">
                <?= csrf_field() ?>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="exam_name"
                               ...
                               value="<?= esc(old('exam_name', $exam['exam_name'])) ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="level_id_fk"
                            ...
                            <option value="<?= $level['level_id'] ?>"
                                <?= old('level_id_fk', $exam['level_id_fk']) == $level['level_id'] ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="exam_status" class="form-select form-select-solid">
                            <option value="Active"   <?= old('exam_status', $exam['exam_status']) === 'Active'   ? 'selected' : '' ?>>Active</option>
                            <option value="Inactive" <?= old('exam_status', $exam['exam_status']) === 'Inactive' ? 'selected' : '' ?>>Inactive</option>
                        </select>
                    </div>
                ...
                <div class="d-flex justify-content-end mt-8 gap-3">
                    <a href="<?= base_url('exam/detail/' . $exam['exam_id']) ?>" class="btn btn-light">Cancel</a>
