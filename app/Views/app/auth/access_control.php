	...
	<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
		...
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			...
			<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
				...
				<!--end::Item-->
				<!--begin::Item-->
				<li class="breadcrumb-item text-muted">Access Control</li>
				<!--end::Item-->
			</ul>
			<!--end::Breadcrumb-->
		</div>
		...
		<div class="card mb-5 mb-xl-10">
			...
			<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
				...
				<div class="card-title m-0">
					<h3 class="fw-bold m-0">Role Base Access Control</h3>
				</div>
				<!--end::Card title-->
			</div>
			<!--begin::Card header-->
        			        ...
        			        <div class="col-md-12">
                                ...
                                <div class="alert alert-danger d-flex align-items-center p-5">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <!--begin::Content-->
                                        <span>Your user role does not have permission to access this resource. <a href="<?php echo base_url('role/permission/'.session()->get('roleID')); ?>">Click here</a> to see your user access.</span>
                                        <!--end::Content-->
                                    </div>
                                    <!--end::Wrapper-->
                                </div>
