    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack flex-wrap gap-3">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">My Timetable</li>
            </ul>
        </div>
    </div>
</div>
    ...
    <?php if (!$ttData): ?>
        <div class="card">
            <div class="card-body py-12 text-center">
                ...
                <div class="text-gray-600 fw-semibold fs-5 mb-2">No timetable available</div>
                <div class="text-muted fs-7">There is no active timetable for your class yet. Please check back later or contact your school administrator.</div>
            </div>
        </div>
    <?php else: ?>
...
<?php else: ?>
    <?php if (empty($children)): ?>
        <div class="card">
            <div class="card-body py-12 text-center">
                <i class="ki-duotone ki-people fs-3x text-muted mb-4 d-block"><span class="path1"></span><span class="path2"></span></i>
                <div class="text-gray-600 fw-semibold fs-5 mb-2">No children linked</div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <span class="text-muted fs-7"><?= esc($tt['level_name'] ?? '') ?> · <?= esc($tt['academic_year']) ?> Term <?= esc($tt['term']) ?></span>
            </div>
        </div>
        <div class="card-body p-0">
    <?php endif; ?>
