    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">Child Admission</li>
            </ul>
        </div>
    </div>
</div>
...
<div id="kt_app_content_container" class="app-container container-xxl">
    ...
    <div class="card">
        <div class="card-header border-0 flex-wrap py-5 gap-3" style="min-height:unset;">
            <div class="d-flex flex-wrap align-items-center gap-3" style="flex:1 1 auto;min-width:0;">
                <div class="d-flex align-items-center position-relative" style="flex:1 1 200px;min-width:160px;">
                    ...
                    <input type="text" id="search-child-admission" class="form-control w-100 ps-12" placeholder="Search child admissions...">
                </div>
            </div>
        </div>
        ...
        <div class="card-body pt-4">
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-3" id="child-admission-table">
                <thead>
...
<?= $this->include('app/admission/_my_detail_modal_shell') ?>
...
(function () {
    ...
    const table = document.getElementById('child-admission-table');
    ...
    const datatable = $(table).DataTable({
        ...
        searchDelay: 500,
        ajax: {
            url:  '<?= base_url('admission/child/my/listing') ?>',
            type: 'POST',
            data: function (d) {
                d[csrfName] = csrfHash;
                return d;
        ...
        columns: [
            ...
            { data: 'admission_status',name: 'admission_status', orderable: false },
        ...
        language: {
            ...
            emptyTable:   'No admission records found for your children.',
            zeroRecords:  'No matching admission records found.',
            info:         'Showing _START_ to _END_ of _TOTAL_ admissions',
            infoFiltered: '(filtered from _MAX_ total)',
            infoEmpty:    'No admission records found.',
        },
        drawCallback: function () {
            bindAdmissionViewButtons();
        }
    });

    let searchTimer;
    document.getElementById('search-child-admission').addEventListener('input', function () {
    ...
    function bindAdmissionViewButtons() {
        document.querySelectorAll('.btn-view-admission').forEach(function (btn) {
            if (btn._viewBound) return;
            btn._viewBound = true;
            btn.addEventListener('click', function () {
                loadAdmissionDetail(btn.dataset.id, '<?= base_url('admission/my/detail/') ?>');
            });
        });
    }
})();
