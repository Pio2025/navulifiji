    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">My Admission</li>
            </ul>
        </div>
    </div>
</div>
...
<div id="kt_app_content_container" class="app-container container-xxl">
    ...
    <div class="card">
        <div class="card-header border-0 flex-wrap py-5 gap-3" style="min-height:unset;">
            <div class="d-flex flex-wrap align-items-center gap-3" style="flex:1 1 auto;min-width:0;">
                <div class="d-flex align-items-center position-relative" style="flex:1 1 200px;min-width:160px;">
                    ...
                    <input type="text" id="search-my-admission" class="form-control w-100 ps-12" placeholder="Search my admissions...">
                </div>
            </div>
        </div>
        ...
        <div class="card-body pt-4">
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-3" id="my-admission-table">
                <thead>
...
(function () {
    ...
    const table = document.getElementById('my-admission-table');
    ...
    const datatable = $(table).DataTable({
        ...
        searchDelay: 500,
        ajax: {
            url:  '<?= base_url('admission/my/listing') ?>',
            type: 'POST',
            data: function (d) {
                d[csrfName] = csrfHash;
                return d;
        ...
        language: {
            ...
            emptyTable:   'You have no admission records yet.',
    ...
    let searchTimer;
    document.getElementById('search-my-admission').addEventListener('input', function () {
