	...
	<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
		...
		<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
			...
			<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
				...
				<!--begin::Item-->
				<li class="breadcrumb-item text-muted">
					<a href="<?php echo base_url('role/add'); ?>" class="text-muted text-hover-primary">Add Role</a>
				</li>
				<!--end::Item-->
				<!--begin::Item-->
				<li class="breadcrumb-item">
	...
	<div id="kt_app_content_container" class="app-container container-xxl">
		...
		<div class="card">
			...
			<div class="card-body py-4">
				<!--begin::Form-->
				<form id="kt_role_add_form" class="form" action="<?php echo base_url('role/update/'.$role->role_id); ?>" method="POST">
					<?= csrf_field() ?>
					...
					<div class="row mb-6">
						...
						<div class="col-lg-12">
							<textarea name="role_desc" 
									  ...
									  rows="5"
									  placeholder="Enter a detailed description of this role's responsibilities and access level..."><?= old('role_desc', $role->role_desc ?? '') ?></textarea>
