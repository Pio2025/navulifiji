...
<div class="pd-child-tabs mb-2" id="pd-child-tabs">
    <button type="button" class="pd-child-tab active" data-child="self">
        <i class="ki-duotone ki-profile-circle fs-3 me-1"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
        My Dashboard
    </button>
...
<?php include APPPATH . 'Views/app/dashboard/_generic_body.php'; ?>
</div>
