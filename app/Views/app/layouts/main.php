...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5">
											<a href="<?php echo base_url('profile/my'); ?>" class="menu-link px-5">User Profile</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu separator-->
										<div class="separator my-2"></div>
										...
										<div class="menu-item px-5">
											<div class="menu-content d-flex align-items-center justify-content-between px-3 py-1">
												<span class="text-gray-600 fw-semibold fs-7">Mode</span>
												<div class="d-flex gap-2">
													<a href="#" class="btn btn-icon btn-sm btn-active-light-primary" onclick="KTThemeMode.setMode('light'); return false;" title="Light">
														<i class="ki-duotone ki-night-day fs-2">
															<span class="path1"></span>
															<span class="path2"></span>
															<span class="path3"></span>
													...
													<a href="#" class="btn btn-icon btn-sm btn-active-light-primary" onclick="KTThemeMode.setMode('dark'); return false;" title="Dark">
														<i class="ki-duotone ki-moon fs-2">
															<span class="path1"></span>
															<span class="path2"></span>
														</i>
													</a>
													<a href="#" class="btn btn-icon btn-sm btn-active-light-primary" onclick="KTThemeMode.setMode('system'); return false;" title="System">
														<i class="ki-duotone ki-screen fs-2">
															<span class="path1"></span>
															<span class="path2"></span>
															<span class="path3"></span>
		...
		#ucl_popup {
			position: fixed;
			bottom: 153px; /* 87px dock + 52px button + 14px gap */
			right: 7px;
			width: 290px;
			max-height: 380px;
			background: #fff;
		...
		/* ── Bottom dock wrapper ── */
		#chat_bottom_dock {
			position: fixed; bottom: 87px; right: 7px;
