...
class LinkEconomicsSubjects extends Migration
{
    public function up(): void
    {
        ...
        // Subject names use the singular "Economic", the category is "Economics"
        $db->query(
            "UPDATE subject SET sub_cat_id_fk = ? WHERE subject_name REGEXP ? AND sub_cat_id_fk = 0",
            [$catId, '^Year [0-9]+ Economic$']
        );
    }
